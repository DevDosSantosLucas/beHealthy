...
export default function Dashboard (){
    ...
    return(
      <View style = {styles.container }>
          ...
          <Text style = { styles.labelText}>Informe abaixo para que possamos sugerir a quantidade de água ideal para você!</Text>
    ...
    <Text style = { styles.label}>Quantos Litros {'\n'}você bebeu hoje ? </Text>
            <TextInput
            style={styles.input}
            // value={peso}
            // onChangeText = {setPeso}
          ...
          <Text style = { styles.labelText}>Ver quantidade de{'\n'} água recomendada</Text>
